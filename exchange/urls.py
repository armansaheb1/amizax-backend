...
#  < ------------ General
   ...
   path('maintrades/<id>' , views.maintrades.as_view() , name='maintrades'),
   ...
   path('generalbtc', views.generalbtc.as_view() , name='generalbtc'),
   path('sellpercent', views.sellpercent.as_view() , name='sellpercent'),
   path('email/<str:code>', views.regemailverify.as_view() , name='regemailverify'),
   path('send_next', views.send_next.as_view() , name='send_next'),
   path('p2prequests', views.p2prequests.as_view() , name='p2prequests'),
   path('p2prequests/<pk>', views.p2prequests.as_view() , name='p2prequests'),
   path('p2pmyorders', views.p2pmyorders.as_view() , name='p2pmyorders'),
   path('p2pmyorders/<id>', views.p2pmyorders.as_view() , name='p2pmyorders'),
   path('p2pmybuyorders', views.p2pmybuyorders.as_view() , name='p2pmybuyorders'),
   path('p2pbuy/<id>', views.p2pbuy.as_view() , name='p2pbuy'),
   path('p2pbuyaccept/<id>', views.p2pbuyaccept.as_view() , name='p2pbuyaccept'),
   path('p2pacceptget/<id>', views.p2pacceptget.as_view() , name='p2pacceptget'),
   path('p2pbuypay/<id>', views.p2pbuypay.as_view() , name='p2pbuypay'),
   path('p2psent/<id>', views.p2psent.as_view() , name='p2psent'),
   path('mychatrooms', views.MyChatRooms.as_view() , name='mychatrooms'),
   path('mychatrooms/<id>', views.MyChatRooms.as_view() , name='mychatrooms'),
   path('createsmscode', views.createsmscode.as_view() , name='createsmscode'),
   path('p2pverifys/<uuid:transid>/', views.p2pverifys , name='p2pverifys'),
   
   path('chattext', views.ChatTexts.as_view() , name='chattext'),
   path('chattext/<id>', views.ChatTexts.as_view() , name='chattext'),
   path('chains', views.chains.as_view() , name='chains'),
#  General  ------------ >   
#  < ------------ Main Trades 

   path('maintradebuyorders/<id>' , views.maintradebuyorders.as_view() , name='maintradebuyorders'),
   path('maintradesellorders/<id>' , views.maintradesellorders.as_view() , name='maintradesellorders'),
   path('maintradesinfo/<id>' , views.maintradesinfo.as_view() , name='maintradesinfo'),
...
#  < ------------ Margin Trades 
   ...
   path('oltradeinfo4' , views.oltradeinfo4.as_view() , name='oltradeinfo4'),
   ...
   path('cp_wallets2' , views.cp_wallets2.as_view() , name='cp_wallets2'),
