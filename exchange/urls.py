...
#  < ------------ General
   ...
   path('addreferal' , views.addreferal.as_view() , name='addreferal'),
   ...
   path('buyhis' , views.buyhis.as_view() , name='buyhis'),
...
#  < ------------ Margin Trades 
   ...
   path('cp_borrow_get' , views.cp_borrow_get.as_view() , name='cp_borrow_get'),
   ...
   path('cp_deposit' , views.cp_deposit.as_view() , name='cp_deposit'),
