    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plans', to='exchange.cp_currencies')),
            ],
            options={
                'verbose_name': 'پلن ها',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2023, 3, 13, 14, 39, 38, 403258))),
            ],
        ),
        migrations.CreateModel(
            name='Subjects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan', to='exchange.plans')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userplanssss', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ...
                ('otp', models.CharField(default='dnwwva6ngbza9044', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.now)),
                ('amount', models.FloatField()),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userplanss', to='exchange.cp_currencies')),
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userplansss', to='exchange.plans')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userplans', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
