...
urlpatterns = [
   ...
   path('exchangedone' , views.exchangedone.as_view() , name='exchangedone'),
   path('exchangereject' , views.exchangereject.as_view() , name='exchangereject'),
   path('cp_deposit' , views.cp_deposit.as_view() , name='cp_deposit'),
   path('cp_depositdone' , views.cp_depositdone.as_view() , name='cp_depositdone'),
